...
component accessors="true"{
	...
	*/
	BaseORMService function init(
		...
		variables.ORM = new util.ORMUtilFactory().getORMUtil();
		// Create the service ORM Event Handler
		variables.ORMEventHandler = new EventHandler();
		...
		variables.restrictions  = new criterion.Restrictions();
	...
	*/
	any function createService(
		...
		return new VirtualEntityService( argumentCollection=arguments );
	}
